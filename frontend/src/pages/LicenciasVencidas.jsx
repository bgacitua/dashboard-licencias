...
const LicenciasVencidas = () => {
    const { vencidasRecientes, loading, error, recargar } = useLicencias();
    ...
    const sortedLicencias = useMemo(() => {
        if (!vencidasRecientes) return [];
        
        return [...vencidasRecientes].sort((a, b) => {
            const dateA = new Date(a.fecha_inicio);
            const dateB = new Date(b.fecha_inicio);
            return sortOrder === 'asc' ? dateA - dateB : dateB - dateA;
        });
    }, [vencidasRecientes, sortOrder]);
        ...
        <div style={{ 
            ...
            <div style={{ marginBottom: '30px', display: 'flex', alignItems: 'center', gap: '20px' }}>
                ...
                <div>
                    <h1 style={{ 
                        ...
                        🔴 Licencias Vencidas Recientemente
                    </h1>
                    <p style={{ margin: 0, color: '#666' }}>
                        Licencias que vencieron en los últimos 5 días
                    </p>
                </div>
            </div>
            ...
            <div style={{ 
                ...
                <span style={{ fontSize: '2rem', fontWeight: 'bold', color: '#ef4444' }}>
                    {vencidasRecientes.length}
                </span>
                <span style={{ color: '#991b1b', fontSize: '1.1rem' }}>
                    licencias vencidas que requieren seguimiento
                </span>
            </div>
...
export default LicenciasVencidas;
