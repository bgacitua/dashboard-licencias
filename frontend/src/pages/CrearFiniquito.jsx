...
const CrearFiniquito = () => {
  ...
  // Hasta que el proceso guardado termine de aplicarse, el autoguardado no puede correr:
  // grabaría el formulario vacío del primer render encima de lo que ya había.
  ...
  useEffect(() => {
    ...
    if (rut) restaurar().finally(() => setHidratado(true));
  }, [location.state, rut]);
